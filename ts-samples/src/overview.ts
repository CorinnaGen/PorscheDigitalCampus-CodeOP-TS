...
const mockArray = [
  { id: "1", displayName: "Corinna", age: "33", role: "admin" },
];
...
/**
 * Generics
 * Generics allow us to create reusable components that can work with a
 * variety of data types rather than a single one.
 * View AutocompleteWithGenerics.tsx for more details
 */
